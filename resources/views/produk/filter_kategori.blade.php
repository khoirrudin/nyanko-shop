...
<div class="container mt-5 p-2">
    <h3 class="fw-bold">Produk dengan kategori {{ $nama_kategori->kategori }}</h3>
    <div class="row mt-3">
        ...
        <input hidden type="text" name="user_id" id="user_id" value="{{ $value }}">
            <div class="col-md-3 mb-4 ">
                ...
                <div class="bdcard border border-info kategori">
                    <img src="{{ asset('img_produk_anak_kucing/'.$produk->gambar_produk) }}" class="card-img-top rounded3" alt="Gambar Produk">
                    <div class="card-body">
