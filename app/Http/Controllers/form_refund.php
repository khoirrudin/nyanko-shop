...
class form_refund extends Controller
{
    public function form_refund()
    {
        $user_id = Auth::user()->id;
            ...
            $data_keranjang = DB::table('keranjang')
                    ...
                    ->where('keranjang.status_produk', 6)
                    ->get();
        ...
        return view('pembeli.form_refund', $data);
    }
    public function upload_form_refund(Request $request)
    {
        try {
            $user_id = Auth::user()->id;
